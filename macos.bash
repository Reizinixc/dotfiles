...
# Some commands are from https://github.com/Wyvern/macos/blob/master/macOS

# Disable stuffs that don't use
...
# Reduce system log size to 1 day
...
# Setup login screen message
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText "\ud83d\ude2d\u8ff7\u5b50\u306b\u306a\u3063\u3061\u3083\u3063\u305f\u3002080-2388-3548\u307e\u3067\u3054\u9023\u7d61\u304f\u3060\u3055\u3044\ud83d\ude2d"
...
# Change menu bar space width
defaults -currentHost write -globalDomain NSStatusItemSpacing -int 10
defaults -currentHost write -globalDomain NSStatusItemSelectionPadding -int 6

# Remove date from menu bar
defaults write com.apple.menuextra.clock "DateFormat" -string ""

# Show all configuration in the system settings
sudo defaults delete /Library/Preferences/com.apple.systempreferences HiddenPreferencePanes

# Show a display resolution in the Display settings
...
# Trackpad: enable two-finger scrolling
defaults write com.apple.AppleMultitouchTrackpad TrackpadScroll -bool true

# Trackpad: change trackpad click force to lightest
defaults write com.apple.AppleMultitouchTrackpad "FirstClickThreshold" -int 0

# Keyboard: set function key as default
defaults write NSGlobalDomain com.apple.keyboard.fnState -bool true

# Mouse: change mouse scale
...
defaults write NSGlobalDomain AppleLanguages -array "en-GB" "ja-JP"
defaults write NSGlobalDomain AppleLocale -string "en_GB@rg=jpzzzz"
...
systemsetup -setusingnetworktime on -setnetworktimeserver pool.ntp.org
...
# Finder: open a new folder in a new window
defaults write com.apple.finder FinderSpawnTab -bool false

# Finder: always show an icon on the title bar
...
# Change the dock to the left side
